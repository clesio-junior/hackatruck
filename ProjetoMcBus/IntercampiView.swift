            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    Picker("Sentido", selection: $selectedDirection) {
                        ...
                        Text("Sentido Boa Vista").tag("Sentido Boa Vista")
                    }
...
//                    Colocar o sentido atraves do campo ponto da struct
                    ...
                    ScrollView {
                        if(selectedDirection == "Sentido UFU"){
                            ForEach(vmPontos.arrayPontos.filter { $0.rota == "inter" }) { ponto in
                                if(ponto.tipo == "ida"){
                                    HStack {
                        ...
                        if(selectedDirection == "Sentido Boa Vista"){
                            ForEach(vmPontos.arrayPontos.filter { $0.rota == "inter" }) { ponto in
                                if(ponto.tipo == "volta"){
                                    HStack {
